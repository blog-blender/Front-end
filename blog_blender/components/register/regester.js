          ...
          <div className={styles.div1}>
            <div className={styles.div2}>
              ...
              <form action="" className={styles.form}>
                <input className={styles.input1} type="text" name="firstName" onChange={(a) => setFirstName(a.target.value)} placeholder="FirstName" />
                <input className={styles.input1} type="text" onChange={(s) => setLastName(s.target.value)} name="lastName" placeholder="Last Name" />
                <input className={styles.input1} type="email" name="email" onChange={(e) => setEmail(e.target.value)} placeholder="Email Address" />
                <input className={styles.input1} type="password" onChange={(e) => { setPassword(e.target.value) }} name="password" placeholder="Password" />
                <div class="relative">
                  <input className={styles.input1} type="password" onChange={(e) => { setPassword(e.target.value) }} name="password" placeholder="Confirm Password" />
                </div>
                <div>
