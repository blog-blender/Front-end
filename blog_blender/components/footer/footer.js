...
export default function Footer(props) {
  ...
  return (
    ...
    //           <li class="mb-2">
    //             <a href="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Social Network</a>
    //           </li>
    //           <li class="mb-2">
    //             <a href="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Comment and Post</a>
    //           </li>
    //           <li class="mb-2">
    //             <a href="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Commincate</a>
    //           </li>
    //           <li class="mb-2">
    //             <a href="#" class="border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800">Make Friend</a>
    //           </li>
    //         </ul>
    //       </div>
    ...
    //         <div class="flex sm:justify-center xl:justify-start">
              ...
              //   </svg>
              // </a>
              // <a href="https://github.com/blog-blender" class="w-8 h-8 border border-2 border-gray-400 rounded-full text-center py-1 ml-2 text-gray-600 hover:text-white hover:bg-red-600 hover:border-red-600">
              // <svg
              //     className="h-6 w-6"
              //     fill="currentColor"
              //     viewBox="0 0 21 30"
    ...
    <div class=" flex items-center justify-center bg-[#BAC7CD]">
      <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div class="flex mt-4 flex-col md:flex-row md:justify-between">
          <p class="w-full md:w-2/3 text-white">To ensure that all  content is verifiable, anyone may question an uncited claim. If your work has been tagged</p>
          <div class="w-44 pt-6 md:pt-0">
            <a class="bg-green-300 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">Contact US</a>
          </div>
        </div>
        <div class="flex flex-col">
          <div class="flex mt-12 mb-6 flex-row justify-between">
          ...
          <p class="w-full text-center my-12 text-gray-600">Copyright © 2023 Blog Blender</p>
        </div>
      </div>
    </div>
  )
