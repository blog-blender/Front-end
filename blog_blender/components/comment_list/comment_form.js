...
<div style={{border:'1px solid #E2E8F0'}} class="bg-white-400 rounded-2xl transform -translate-y-5 ">
  ...
  <section class="w-full flex px-3 py-2">
    ...
    <div class="flex-1">
      <textarea class="w-full p-2 bg-transparent outline-none placeholder-gray-600 text-black resize-none overflow-auto max-h-screen" onChange={update} rows="4" placeholder="What's happening?"></textarea>
