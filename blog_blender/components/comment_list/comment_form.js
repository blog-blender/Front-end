...
export default function CommentForm(props) {
  ...
  return (
    ...
    <section class="w-full flex px-3 py-2">
      ...
      <div class="flex-1">
        <textarea class="w-full p-1/5 bg-transparent outline-none placeholder-gray-600 text-black resize-none overflow-auto max-h-screen" onChange={update} rows="4" placeholder="What's happening?">{commentContent}</textarea>
